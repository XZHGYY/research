...
dataset_dir=/data/weixin-40543134/week8 # 数据集目录，这里是写死的，记得修改
...
# config文件
config=ssd_mobilenet_v3_pets.config
...
# 导出模型
python ./object_detection/export_inference_graph.py --input_type image_tensor --pipeline_config_path $pipeline_config_path --trained_checkpoint_prefix $train_dir/model.ckpt-500  --output_directory $output_dir/exported_graphs
